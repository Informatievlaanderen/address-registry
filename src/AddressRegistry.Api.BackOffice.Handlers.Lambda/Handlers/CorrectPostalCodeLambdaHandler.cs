namespace AddressRegistry.Api.BackOffice.Handlers.Lambda.Handlers
{
    ...
    public sealed class CorrectPostalCodeLambdaHandler : SqsLambdaHandler<CorrectPostalCodeLambdaRequest>
    {
        private readonly SyndicationContext _syndicationContext;
        private readonly MunicipalityConsumerContext _municipalityConsumerContext;

        public CorrectPostalCodeLambdaHandler(
        ...
        protected override async Task<ETagResponse> InnerHandle(CorrectPostalCodeLambdaRequest request, CancellationToken cancellationToken)
        {
        ...
        protected override TicketError? InnerMapDomainException(DomainException exception, CorrectPostalCodeLambdaRequest request)
        {
