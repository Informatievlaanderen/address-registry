namespace AddressRegistry.Api.BackOffice.Handlers.Sqs.Handlers
{
    ...
    public sealed class RegularizeSqsHandler : SqsHandler<RegularizeSqsRequest>
    {
        public const string Action = "RegularizeAddress";

        private readonly BackOfficeContext _backOfficeContext;

        public RegularizeSqsHandler(
            ISqsQueue sqsQueue,
        ...
        protected override string? WithAggregateId(RegularizeSqsRequest request)
        {
        ...
        protected override IDictionary<string, string> WithTicketMetadata(string aggregateId, RegularizeSqsRequest sqsRequest)
        {
