namespace AddressRegistry.Tests.BackOffice.Sqs
{
    ...
    public sealed class GivenAddressBackOfficeCorrectDeregularizationRequest : AddressRegistryTest
    {
        private readonly TestBackOfficeContext _backOfficeContext;

        public GivenAddressBackOfficeCorrectDeregularizationRequest(ITestOutputHelper testOutputHelper) : base(testOutputHelper)
        {
        ...
        public async Task ThenTicketWithLocationIsCreated()
        {
            ...
            var sut = new CorrectAddressDeregularizationSqsHandler(
                sqsQueue.Object,
            ...
            {
                Request = new CorrectAddressDeregularizationBackOfficeRequest()
                {
        ...
        public void WithNoStreetNameFoundByAddressPersistentLocalId_ThrowsAggregateIdNotFound()
        {
            ...
            var act = async () => await sut.Handle(
                new CorrectAddressDeregularizationSqsRequest()
                {
                    Request = Fixture.Create<CorrectAddressDeregularizationBackOfficeRequest>()
                }, CancellationToken.None);
