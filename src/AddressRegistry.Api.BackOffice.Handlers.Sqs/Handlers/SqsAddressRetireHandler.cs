namespace AddressRegistry.Api.BackOffice.Handlers.Sqs.Handlers
{
    ...
    public sealed class SqsAddressRetireHandler : SqsHandler<SqsAddressRetireRequest>
    {
        ...
        protected override string? WithAggregateId(SqsAddressRetireRequest request)
        {
        ...
        protected override IDictionary<string, string> WithTicketMetadata(string aggregateId, SqsAddressRetireRequest sqsRequest)
        {
