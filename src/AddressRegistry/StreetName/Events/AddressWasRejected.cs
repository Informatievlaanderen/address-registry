namespace AddressRegistry.StreetName.Events
{
    ...
    public class AddressWasRejected : IStreetNameEvent, IHasAddressPersistentLocalId
    {
        public const string EventName = "AddressWasRejected"; // BE CAREFUL CHANGING THIS!!
