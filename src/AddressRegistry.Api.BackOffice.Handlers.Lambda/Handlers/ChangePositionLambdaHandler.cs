namespace AddressRegistry.Api.BackOffice.Handlers.Lambda.Handlers
{
    ...
    public sealed class ChangePositionLambdaHandler : SqsLambdaHandler<ChangePositionLambdaRequest>
    {
        public ChangePositionLambdaHandler(
        ...
        protected override async Task<ETagResponse> InnerHandle(ChangePositionLambdaRequest request, CancellationToken cancellationToken)
        {
        ...
        protected override TicketError? InnerMapDomainException(DomainException exception, ChangePositionLambdaRequest request)
        {
