...
namespace AddressRegistry.Projections.Wfs.Migrations
{
    ...
    [Migration("20220915144324_RecreateWfsViewWithIndex")]
    partial class RecreateWfsViewWithIndex
    {
            ...
            modelBuilder.Entity("AddressRegistry.Projections.Wfs.AddressDetail.AddressDetailItem", b =>
                {
                    ...
                    b.HasIndex("Removed", "Complete", "StreetNameId");

                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("Removed", "Complete", "StreetNameId"), new[] { "BoxNumber", "HouseNumber", "OfficiallyAssigned", "PersistentLocalId", "Position", "PositionMethod", "PositionSpecification", "PostalCode", "Status", "VersionAsString" });
