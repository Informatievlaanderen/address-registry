namespace AddressRegistry.Api.BackOffice.Handlers.Lambda.Handlers
{
    ...
    public sealed class CorrectAddressHouseNumberLambdaHandler : SqsLambdaHandler<CorrectAddressHouseNumberLambdaRequest>
    {
        public CorrectAddressHouseNumberLambdaHandler(
        ...
        protected override async Task<ETagResponse> InnerHandle(CorrectAddressHouseNumberLambdaRequest request, CancellationToken cancellationToken)
        {
        ...
        protected override TicketError? InnerMapDomainException(DomainException exception, CorrectAddressHouseNumberLambdaRequest request)
        {
