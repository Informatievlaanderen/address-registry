...
namespace AddressRegistry.Projections.Syndication.Migrations
{
    ...
    [Migration("20230303201048_AddStreetNameLatestIndex")]
    partial class AddStreetNameLatestIndex
    {
            ...
            modelBuilder.Entity("AddressRegistry.Projections.Syndication.Parcel.AddressParcelLinkExtractItem", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("IsParcelRemoved", "IsAddressLinkRemoved"), new[] { "AddressId", "ParcelId", "ParcelPersistentLocalId" });
            ...
            modelBuilder.Entity("AddressRegistry.Projections.Syndication.StreetName.StreetNameLatestItem", b =>
                {
                    ...
                    b.HasIndex("NisCode", "IsComplete", "IsRemoved");

                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("NisCode", "IsComplete", "IsRemoved"), new[] { "NameDutchSearch", "NameEnglishSearch", "NameFrenchSearch", "NameGermanSearch" });
