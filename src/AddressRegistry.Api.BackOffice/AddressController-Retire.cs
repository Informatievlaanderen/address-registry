namespace AddressRegistry.Api.BackOffice
{
    ...
    public partial class AddressController
    {
        ...
        /// <response code="204">Als het adres gehistoreerd is.</response>
        /// <response code="409">Als de adres status niet 'ingebruik' is.</response>
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            catch (DomainException exception)
            {
                throw exception switch
                {
                    ...
                    AddressCannotBeRetiredException => CreateValidationException(
                        ValidationErrorCodes.AddressCannotBeRetired,
                        string.Empty,
                        ValidationErrorMessages.AddressCannotBeRetired),
