namespace AddressRegistry.Api.BackOffice.Handlers.Lambda.Handlers
{
    ...
    public sealed class ProposeLambdaHandler : SqsLambdaHandler<ProposeLambdaRequest>
    {
        ...
        protected override async Task<ETagResponse> InnerHandle(ProposeLambdaRequest request, CancellationToken cancellationToken)
        {
        ...
        protected override TicketError? InnerMapDomainException(DomainException exception, ProposeLambdaRequest request)
        {
