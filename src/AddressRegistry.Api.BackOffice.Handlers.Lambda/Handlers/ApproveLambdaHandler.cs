namespace AddressRegistry.Api.BackOffice.Handlers.Lambda.Handlers
{
    ...
    public sealed class ApproveLambdaHandler : SqsLambdaHandler<ApproveLambdaRequest>
    {
        public ApproveLambdaHandler(
        ...
        protected override async Task<ETagResponse> InnerHandle(ApproveLambdaRequest request, CancellationToken cancellationToken)
        {
