namespace AddressRegistry.Tests.WhenImportHouseNumberPositionFromCrab
{
    ...
    public class CrabHouseNumberId1BetaTests : AddressRegistryTest
    {
        public CrabHouseNumberId1BetaTests(ITestOutputHelper testOutputHelper) : base(testOutputHelper)
        {
        }
