namespace AddressRegistry.Projections.Integration.LatestItemV2
{
    ...
    [ConnectedProjectionName("Integratie adres latest item v2")]
    [ConnectedProjectionDescription("Projectie die de laatste adres data voor de integratie database bijhoudt.")]
    public sealed class AddressLatestItemProjectionsV2 : ConnectedProjection<IntegrationContext>
    {
        public AddressLatestItemProjectionsV2(IOptions<IntegrationOptions> options)
        {
            #region StreetName
            ...
            When<Envelope<AddressWasMigratedToStreetName>>(async (context, message, ct) =>
            {
                ...
                var addressLatestItem = new AddressLatestItemV2
                {
            ...
            When<Envelope<AddressHouseNumberWasReaddressed>>(async (context, message, ct) =>
            {
                ...
                {
                    var boxNumberGeometry = PositionReader.ReadPosition(readdressedBoxNumber.SourceExtendedWkbGeometry);
        ...
        private static void UpdateVersionTimestampIfNewer(AddressLatestItemV2 addressLatestItem, Instant versionTimestamp)
        {
        ...
        private static void UpdateVersionTimestamp(AddressLatestItemV2 addressLatestItem, Instant versionTimestamp)
            => addressLatestItem.VersionTimestamp = versionTimestamp;
