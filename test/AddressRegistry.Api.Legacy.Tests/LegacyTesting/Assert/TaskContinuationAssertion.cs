namespace AddressRegistry.Api.Legacy.Tests.LegacyTesting.Assert
{
    ...
    public abstract class TaskContinuationAssertion<TResult, TAssertion> : Assertions<Task<TResult>, TAssertion>
            where TAssertion : TaskContinuationAssertion<TResult, TAssertion>
    {
        protected TaskContinuationAssertion(Task<TResult> subject):base(subject)
        {
        }
        ...
        {
            return new AndContinuationConstraint<TResult, TAssertion>(this as TAssertion);
        }

        protected AndWhichContinuationConstraint<TResult, TAssertion, TWhich> AndWhichContinuation<TWhich>(Task<TWhich> newSubject)
        {
            return new AndWhichContinuationConstraint<TResult, TAssertion, TWhich>(this as TAssertion, newSubject);
        }
