namespace AddressRegistry.Api.BackOffice.Handlers.Sqs
{
    ...
    public class SqsAddressRemoveHandler : SqsHandler<SqsAddressRemoveRequest>
    {
        private readonly BackOfficeContext _backOfficeContext;

        public SqsAddressRemoveHandler(
            ILogger<SqsAddressRemoveHandler> logger,
        ...
        protected override string WithGroupId(SqsAddressRemoveRequest request)
        {
