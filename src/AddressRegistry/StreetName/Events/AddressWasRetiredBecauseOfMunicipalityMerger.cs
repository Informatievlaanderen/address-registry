namespace AddressRegistry.StreetName.Events
{
    ...
    [EventName(EventName)]
    [EventDescription("Het adres werd gehistoreerd in functie van een gemeentefusie.")]
    public class AddressWasRetiredBecauseOfMunicipalityMerger : IStreetNameEvent, IHasAddressPersistentLocalId
    {
        public const string EventName = "AddressWasRetiredBecauseOfMunicipalityMerger"; // BE CAREFUL CHANGING THIS!!
        ...
        [JsonConstructor]
        private AddressWasRetiredBecauseOfMunicipalityMerger(
