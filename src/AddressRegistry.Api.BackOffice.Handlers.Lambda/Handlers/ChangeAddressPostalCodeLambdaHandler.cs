namespace AddressRegistry.Api.BackOffice.Handlers.Lambda.Handlers
{
    ...
    public sealed class ChangeAddressPostalCodeLambdaHandler : SqsLambdaHandler<ChangeAddressPostalCodeLambdaRequest>
    {
       public ChangeAddressPostalCodeLambdaHandler(
        ...
        protected override async Task<ETagResponse> InnerHandle(ChangeAddressPostalCodeLambdaRequest request, CancellationToken cancellationToken)
        {
        ...
        protected override TicketError? InnerMapDomainException(DomainException exception, ChangeAddressPostalCodeLambdaRequest request)
        {
