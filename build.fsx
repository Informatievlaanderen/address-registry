...
Target.create "Containerize_ProjectionsLastChangedList" (fun _ -> containerize "AddressRegistry.Projections.LastChangedList.Console" "projections-last-changed-list-console")
