namespace AddressRegistry.Api.BackOffice.Handlers.Sqs.Handlers
{
    ...
    public sealed class RejectSqsHandler : SqsHandler<RejectSqsRequest>
    {
        public const string Action = "RejectAddress";

        private readonly BackOfficeContext _backOfficeContext;

        public RejectSqsHandler(
            ISqsQueue sqsQueue,
        ...
        protected override string? WithAggregateId(RejectSqsRequest request)
        {
        ...
        protected override IDictionary<string, string> WithTicketMetadata(string aggregateId, RejectSqsRequest sqsRequest)
        {
