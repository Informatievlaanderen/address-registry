namespace AddressRegistry.Api.BackOffice.Handlers.Lambda.Handlers
{
    ...
    public sealed class CorrectBoxNumberLambdaHandler : SqsLambdaHandler<CorrectBoxNumberLambdaRequest>
    {
        public CorrectBoxNumberLambdaHandler(
        ...
        protected override async Task<ETagResponse> InnerHandle(CorrectBoxNumberLambdaRequest request, CancellationToken cancellationToken)
        {
        ...
        protected override TicketError? InnerMapDomainException(DomainException exception, CorrectBoxNumberLambdaRequest request)
        {
