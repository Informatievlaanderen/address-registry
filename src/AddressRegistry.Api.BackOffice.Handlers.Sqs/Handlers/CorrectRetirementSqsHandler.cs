namespace AddressRegistry.Api.BackOffice.Handlers.Sqs.Handlers
{
    ...
    public sealed class CorrectRetirementSqsHandler : SqsHandler<CorrectRetirementSqsRequest>
    {
        public const string Action = "CorrectAddressRetirement";
        private readonly BackOfficeContext _backOfficeContext;

        public CorrectRetirementSqsHandler(
            ISqsQueue sqsQueue,
        ...
        protected override string? WithAggregateId(CorrectRetirementSqsRequest request)
        {
        ...
        protected override IDictionary<string, string> WithTicketMetadata(string aggregateId, CorrectRetirementSqsRequest sqsRequest)
        {
