namespace AddressRegistry.Api.BackOffice.Handlers.Sqs.Handlers
{
    ...
    public sealed class ApproveSqsHandler : SqsHandler<ApproveSqsRequest>
    {
        public const string Action = "ApproveAddress";
        private readonly BackOfficeContext _backOfficeContext;

        public ApproveSqsHandler(
            ISqsQueue sqsQueue,
        ...
        protected override string? WithAggregateId(ApproveSqsRequest request)
        {
        ...
        protected override IDictionary<string, string> WithTicketMetadata(string aggregateId, ApproveSqsRequest sqsRequest)
        {
