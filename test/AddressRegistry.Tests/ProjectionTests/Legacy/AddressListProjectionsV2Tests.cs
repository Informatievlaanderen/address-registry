    ...
    public class AddressListProjectionsV2Tests : AddressLegacyProjectionTest<AddressListProjectionsV2>
    {
        ...
        public async Task WhenAddressWasRejectedBecauseOfMunicipalityMerger()
        {
            ...
            await Sut
                .Given(
                    new Envelope<AddressWasProposedV2>(new Envelope(addressWasProposedV2, metadata)),
                    new Envelope<AddressWasRejectedBecauseOfMunicipalityMerger>(new Envelope(addressWasRejected, metadata2)))
                .Then(async ct =>
                {
                    var addressListItemV2 = (await ct.AddressListV2.FindAsync(addressWasRejected.AddressPersistentLocalId));
                    addressListItemV2.Should().NotBeNull();
        ...
        public async Task WhenAddressBoxNumbersWereCorrected()
        {
            ...
            await Sut
                ...
                .Then(async ct =>
                {
                    ...
                    var addressListItemV2 = (await ct.AddressListV2.FindAsync(addressPersistentLocalId));
                    addressListItemV2.Should().NotBeNull();
                    addressListItemV2!.BoxNumber.Should().Be(boxNumber);
                    addressListItemV2.VersionTimestamp.Should().Be(addressBoxNumbersWereCorrected.Provenance.Timestamp);
                    addressListItemV2.LastEventHash.Should().Be(addressBoxNumbersWereCorrected.GetHash());
                });
        }
        ...
        public async Task WhenStreetNameNamesWereChanged()
        {
            ...
            await Sut
                ...
                .Then(async ct =>
                {
                    var addressListItemV2 = (await ct.AddressListV2.FindAsync(addressWasProposedV2.AddressPersistentLocalId));
                    addressListItemV2.Should().NotBeNull();
                    addressListItemV2.VersionTimestamp.Should().Be(streetNameNamesWereChanged.Provenance.Timestamp);
                    addressListItemV2.LastEventHash.Should().Be(streetNameNamesWereChanged.GetHash());
                });
        }
