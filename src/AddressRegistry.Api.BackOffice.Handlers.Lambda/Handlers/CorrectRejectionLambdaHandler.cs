namespace AddressRegistry.Api.BackOffice.Handlers.Lambda.Handlers
{
    ...
    public sealed class CorrectRejectionLambdaHandler : SqsLambdaHandler<CorrectRejectionLambdaRequest>
    {
        public CorrectRejectionLambdaHandler(
        ...
        protected override async Task<ETagResponse> InnerHandle(CorrectRejectionLambdaRequest request, CancellationToken cancellationToken)
        {
        ...
        protected override TicketError? InnerMapDomainException(DomainException exception, CorrectRejectionLambdaRequest request)
        {
