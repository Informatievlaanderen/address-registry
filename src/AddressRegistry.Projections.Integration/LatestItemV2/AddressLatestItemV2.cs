namespace AddressRegistry.Projections.Integration.LatestItemV2
{
    ...
    public sealed class AddressLatestItemV2
    {
        ...
        public AddressLatestItemV2()
        { }
    }

    public sealed class AddressLatestItemV2Configuration : IEntityTypeConfiguration<AddressLatestItemV2>
    {
        public void Configure(EntityTypeBuilder<AddressLatestItemV2> builder)
        {
            const string tableName = "address_latest_items_v2";
            ...
            builder.Property(AddressLatestItemV2.VersionTimestampBackingPropertyName).HasColumnName("version_timestamp");
