namespace AddressRegistry.Api.BackOffice
{
    ...
    {
        /// <summary>
        /// Corrigeer huisnummer van een adres.
        /// </summary>
        ...
        /// <response code="202">Aanvraag tot correctie adres huisnummer wordt reeds verwerkt.</response>
        /// <response code="400">Als de adres status niet 'voorgesteld' of 'ingebruik' is.</response>
        /// <response code="412">Als de If-Match header niet overeenkomt met de laatste ETag.</response>
        /// <returns></returns>
        [HttpPost("{persistentLocalId}/acties/corrigeren/huisnummer")]
        ...
        public async Task<IActionResult> CorrectHouseNumber(
            [FromServices] IValidator<CorrectAddressHouseNumberRequest> validator,
            [FromServices] IIfMatchHeaderValidator ifMatchHeaderValidator,
            [FromRoute] int persistentLocalId,
            [FromBody] CorrectAddressHouseNumberRequest request,
