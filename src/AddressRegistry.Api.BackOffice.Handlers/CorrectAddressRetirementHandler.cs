namespace AddressRegistry.Api.BackOffice.Handlers
{
    ...
    public sealed class CorrectAddressRetirementHandler : BusHandler, IRequestHandler<AddressCorrectRetirementRequest, ETagResponse>
    {
        private readonly IStreetNames _streetNames;
        private readonly BackOfficeContext _backOfficeContext;
        private readonly IdempotencyContext _idempotencyContext;

        public CorrectAddressRetirementHandler(
