namespace AddressRegistry.Api.BackOffice.Handlers.Lambda.Handlers
{
    ...
    public sealed class CorrectAddressPositionLambdaHandler : SqsLambdaHandler<CorrectAddressPositionLambdaRequest>
    {
        public CorrectAddressPositionLambdaHandler(
        ...
        protected override async Task<ETagResponse> InnerHandle(CorrectAddressPositionLambdaRequest request, CancellationToken cancellationToken)
        {
        ...
        protected override TicketError? InnerMapDomainException(DomainException exception, CorrectAddressPositionLambdaRequest request)
        {
