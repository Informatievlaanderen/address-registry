        ...
        public async Task WhenAddressPositionCrsWasChanged()
        {
            ...
            await Sut
                ...
                .Then(async ct =>
                {
                    ...
                    addressWmsItem.Should().NotBeNull();
                    addressWmsItem!.PositionMethod.Should().Be(AddressWmsItemV4Projections.ConvertGeometryMethodToString(addressPositionCrsWasChanged.GeometryMethod));
                    addressWmsItem.PositionSpecification.Should().Be(AddressWmsItemV4Projections.ConvertGeometrySpecificationToString(addressPositionCrsWasChanged.GeometrySpecification));
                    addressWmsItem.Position.Should().Be(ExpectedPosition(addressPositionCrsWasChanged.ExtendedWkbGeometry));
