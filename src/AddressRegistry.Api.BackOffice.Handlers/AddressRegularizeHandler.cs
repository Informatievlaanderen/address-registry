namespace AddressRegistry.Api.BackOffice.Handlers
{
    ...
    public sealed class AddressRegularizeHandler : BusHandler, IRequestHandler<AddressRegularizeRequest, ETagResponse>
    {
        private readonly IStreetNames _streetNames;
        private readonly BackOfficeContext _backOfficeContext;
        private readonly IdempotencyContext _idempotencyContext;

        public AddressRegularizeHandler(
        ...
        public async Task<ETagResponse> Handle(AddressRegularizeRequest request, CancellationToken cancellationToken)
        {
