...
namespace AddressRegistry.StreetName.Events
{
    ...
    public class AddressWasRejectedBecauseHouseNumberWasRetired : IStreetNameEvent, IHasAddressPersistentLocalId
    {
        public const string EventName = "AddressWasRejectedBecauseHouseNumberWasRetired"; // BE CAREFUL CHANGING THIS!!
        ...
        [JsonConstructor]
        private AddressWasRejectedBecauseHouseNumberWasRetired(
