namespace AddressRegistry.Api.BackOffice.Handlers.Lambda.Handlers
{
    ...
    public sealed class DeregulateAddressLambdaHandler : SqsLambdaHandler<DeregulateAddressLambdaRequest>
    {
        public DeregulateAddressLambdaHandler(
        ...
        protected override async Task<ETagResponse> InnerHandle(DeregulateAddressLambdaRequest request, CancellationToken cancellationToken)
        {
        ...
        protected override TicketError? InnerMapDomainException(DomainException exception, DeregulateAddressLambdaRequest request)
        {
