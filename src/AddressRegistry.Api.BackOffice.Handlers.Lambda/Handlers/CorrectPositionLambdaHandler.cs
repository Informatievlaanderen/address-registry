namespace AddressRegistry.Api.BackOffice.Handlers.Lambda.Handlers
{
    ...
    public sealed class CorrectPositionLambdaHandler : SqsLambdaHandler<CorrectPositionLambdaRequest>
    {
        public CorrectPositionLambdaHandler(
        ...
        protected override async Task<ETagResponse> InnerHandle(CorrectPositionLambdaRequest request, CancellationToken cancellationToken)
        {
        ...
        protected override TicketError? InnerMapDomainException(DomainException exception, CorrectPositionLambdaRequest request)
        {
