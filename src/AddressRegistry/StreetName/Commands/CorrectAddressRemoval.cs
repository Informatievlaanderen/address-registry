namespace AddressRegistry.StreetName.Commands
{
    ...
    public class CorrectAddressRemoval : IHasCommandProvenance
    {
        private static readonly Guid Namespace = new Guid("538b2703-69db-4c33-ae2c-101703926eb5");
        ...
        public Guid CreateCommandId()
            => Deterministic.Create(Namespace, $"CorrectAddressRemoval-{ToString()}");
