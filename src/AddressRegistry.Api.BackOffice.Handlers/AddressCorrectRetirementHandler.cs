namespace AddressRegistry.Api.BackOffice.Handlers
{
    ...
    public sealed class AddressCorrectRetirementHandler : BusHandler, IRequestHandler<AddressCorrectRetirementRequest, ETagResponse>
    {
        private readonly IStreetNames _streetNames;
        private readonly BackOfficeContext _backOfficeContext;
        private readonly IdempotencyContext _idempotencyContext;

        public AddressCorrectRetirementHandler(
        ...
        public async Task<ETagResponse> Handle(AddressCorrectRetirementRequest request, CancellationToken cancellationToken)
        {
            ...
            var cmd = new CorrectAddressRetirement(
