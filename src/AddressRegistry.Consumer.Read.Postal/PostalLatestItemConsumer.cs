namespace AddressRegistry.Consumer.Read.Postal
{
    ...
    public class PostalLatestItemConsumer : BackgroundService
    {
        ...
        private async Task ConsumeHandler(ConnectedProjector<PostalConsumerContext> latestItemProjector, object message, MessageContext messageContext)
        {
            ...
            await context.UpdateProjectionState(typeof(PostalLatestItemConsumer).FullName, messageContext.Offset, CancellationToken.None);
