    ...
    public sealed class AddressLatestItemTests : IntegrationProjectionTest<AddressLatestItemProjections>
    {
        ...
        public async Task WhenAddressBoxNumbersWereCorrected()
        {
            ...
            await Sut
                ...
                .Then(async ct =>
                {
                    ...
                    var expectedLatestItem = await ct.AddressLatestItems.FindAsync(addressPersistentLocalId);
                    expectedLatestItem.Should().NotBeNull();
        ...
        public async Task WhenAddressPositionCrsWasChanged()
        {
            ...
            await Sut
                ...
                {
                    var expectedLatestItem =
                        await ct.AddressLatestItems.FindAsync(addressPositionCrsWasChanged.AddressPersistentLocalId);
                    expectedLatestItem.Should().NotBeNull();
                    expectedLatestItem!.StreetNamePersistentLocalId.Should()
