namespace AddressRegistry.Tests.Integration
{
    ...
    public class AddressLatestItemTests : IntegrationProjectionTest<AddressLatestItemProjections>
    {
        private const string Namespace = "https://data.vlaanderen.be/id/adres";
        private readonly Fixture _fixture;
        private StreetNameConsumerContext _streetNameConsumerContext;
        ...
        public AddressLatestItemTests()
        {
            ...
            _streetNameConsumerContext = CreateStreetNameConsumerContext();
        }
        ...
        public async Task WhenAddressWasMigratedToStreetName()
        {
            ...
            await _streetNameConsumerContext.StreetNameLatestItems.AddAsync(
                new StreetNameLatestItem(
                    addressWasMigratedToStreetName.StreetNamePersistentLocalId,
                    nisCode));
            ...
            await Sut
                ...
                .Then(async ct =>
                {
                    ...
                    expectedLatestItem.Status.Should().Be(addressWasMigratedToStreetName.Status.Map());
                    expectedLatestItem.OfficiallyAssigned.Should().Be(addressWasMigratedToStreetName.OfficiallyAssigned);
                    expectedLatestItem.PositionMethod.Should().Be(addressWasMigratedToStreetName.GeometryMethod.ToPositieGeometrieMethode());
                    ...
                    expectedLatestItem.NisCode.Should().Be(nisCode);
        ...
        public async Task WhenAddressWasProposedV2()
        {
            ...
            await Sut
                ...
                .Then(async ct =>
                {
                    ...
                    expectedLatestItem.Status.Should().Be(AddressStatus.Proposed.Map());
                    expectedLatestItem.OfficiallyAssigned.Should().BeTrue();
                    expectedLatestItem.PositionMethod.Should().Be(addressWasProposedV2.GeometryMethod.ToPositieGeometrieMethode());
                    expectedLatestItem.PositionSpecification.Should().Be(addressWasProposedV2.GeometrySpecification.ToPositieSpecificatie());
        ...
        public async Task WhenAddressWasApproved()
        {
            ...
            await _streetNameConsumerContext.StreetNameLatestItems.AddAsync(
                new StreetNameLatestItem(
                    addressWasApproved.StreetNamePersistentLocalId,
                    nisCode));
            await _streetNameConsumerContext.SaveChangesAsync();
            ...
            await Sut
                ...
                .Then(async ct =>
                {
                    ...
                    expectedLatestItem.Status.Should().Be(AddressStatus.Current.Map());
                    expectedLatestItem.OfficiallyAssigned.Should().BeTrue();
                    expectedLatestItem.Removed.Should().BeFalse();
                    expectedLatestItem.NisCode.Should().Be(nisCode);
        ...
        public async Task WhenAddressWasCorrectedFromApprovedToProposed()
        {
            ...
            await _streetNameConsumerContext.StreetNameLatestItems.AddAsync(
                new StreetNameLatestItem(
                    addressWasCorrectedFromApprovedToProposed.StreetNamePersistentLocalId,
                    nisCode));
            await _streetNameConsumerContext.SaveChangesAsync();
        ...
        public async Task WhenAddressWasCorrectedFromApprovedToProposedBecauseHouseNumberWasCorrected()
        {
            ...
            await _streetNameConsumerContext.StreetNameLatestItems.AddAsync(
                new StreetNameLatestItem(
                    addressWasCorrectedFromApprovedToProposedBecauseHouseNumberWasCorrected.StreetNamePersistentLocalId,
                    nisCode));
            await _streetNameConsumerContext.SaveChangesAsync();
        ...
        public async Task WhenAddressWasRejected()
        {
            ...
            await _streetNameConsumerContext.StreetNameLatestItems.AddAsync(
                new StreetNameLatestItem(
                    addressWasRejected.StreetNamePersistentLocalId,
                    nisCode));
            await _streetNameConsumerContext.SaveChangesAsync();
            ...
            await Sut
                ...
                .Then(async ct =>
                {
                    ...
                    expectedLatestItem.Status.Should().Be(AddressStatus.Rejected.Map());
                    expectedLatestItem.OfficiallyAssigned.Should().BeTrue();
                    expectedLatestItem.Removed.Should().BeFalse();
                    expectedLatestItem.NisCode.Should().Be(nisCode);
        ...
        public async Task WhenAddressWasRejectedBecauseHouseNumberWasRejected()
        {
            ...
            await _streetNameConsumerContext.StreetNameLatestItems.AddAsync(
                new StreetNameLatestItem(
                    addressWasRejectedBecauseHouseNumberWasRejected.StreetNamePersistentLocalId,
                    nisCode));
            await _streetNameConsumerContext.SaveChangesAsync();
        ...
        public async Task WhenAddressWasRejectedBecauseHouseNumberWasRetired()
        {
            ...
            await _streetNameConsumerContext.StreetNameLatestItems.AddAsync(
                new StreetNameLatestItem(
                    addressWasRejectedBecauseHouseNumberWasRetired.StreetNamePersistentLocalId,
                    nisCode));
            await _streetNameConsumerContext.SaveChangesAsync();
        ...
        public async Task WhenAddressWasRejectedBecauseStreetNameWasRejected()
        {
            ...
            await _streetNameConsumerContext.StreetNameLatestItems.AddAsync(
                new StreetNameLatestItem(
                    addressWasRejectedBecauseStreetNameWasRejected.StreetNamePersistentLocalId,
                    nisCode));
            await _streetNameConsumerContext.SaveChangesAsync();
        ...
        public async Task WhenAddressWasRetiredBecauseStreetNameWasRejected()
        {
            ...
            await _streetNameConsumerContext.StreetNameLatestItems.AddAsync(
                new StreetNameLatestItem(
                    addressWasRetiredBecauseStreetNameWasRejected.StreetNamePersistentLocalId,
                    nisCode));
            await _streetNameConsumerContext.SaveChangesAsync();
            ...
            await Sut
                ...
                .Then(async ct =>
                {
                    ...
                    expectedLatestItem.Status.Should().Be(AddressStatus.Retired.Map());
                    expectedLatestItem.OfficiallyAssigned.Should().BeTrue();
                    expectedLatestItem.Removed.Should().BeFalse();
                    expectedLatestItem.NisCode.Should().Be(nisCode);
        ...
        public async Task WhenAddressWasRejectedBecauseStreetNameWasRetired()
        {
            ...
            await _streetNameConsumerContext.StreetNameLatestItems.AddAsync(
                new StreetNameLatestItem(
                    addressWasRejectedBecauseStreetNameWasRetired.StreetNamePersistentLocalId,
                    nisCode));
            await _streetNameConsumerContext.SaveChangesAsync();
        ...
        public async Task WhenAddressWasDeregulated()
        {
            ...
            await _streetNameConsumerContext.StreetNameLatestItems.AddAsync(
                new StreetNameLatestItem(
                    addressWasDeregulated.StreetNamePersistentLocalId,
                    nisCode));
            await _streetNameConsumerContext.SaveChangesAsync();
        ...
        public async Task WhenAddressWasRegularized()
        {
            ...
            await _streetNameConsumerContext.StreetNameLatestItems.AddAsync(
                new StreetNameLatestItem(
                    addressWasRegularized.StreetNamePersistentLocalId,
                    nisCode));
            await _streetNameConsumerContext.SaveChangesAsync();
        ...
        public async Task WhenAddressWasRetiredV2()
        {
            ...
            await _streetNameConsumerContext.StreetNameLatestItems.AddAsync(
                new StreetNameLatestItem(
                    addressWasRetiredV2.StreetNamePersistentLocalId,
                    nisCode));
            await _streetNameConsumerContext.SaveChangesAsync();
        ...
        public async Task WhenAddressWasRetiredBecauseHouseNumberWasRetired()
        {
            ...
            await _streetNameConsumerContext.StreetNameLatestItems.AddAsync(
                new StreetNameLatestItem(
                    addressWasRetiredBecauseHouseNumberWasRetired.StreetNamePersistentLocalId,
                    nisCode));
            await _streetNameConsumerContext.SaveChangesAsync();
        ...
        public async Task WhenAddressWasRetiredBecauseStreetNameWasRetired()
        {
            ...
            await _streetNameConsumerContext.StreetNameLatestItems.AddAsync(
                new StreetNameLatestItem(
                    addressWasRetiredBecauseStreetNameWasRetired.StreetNamePersistentLocalId,
                    nisCode));
            await _streetNameConsumerContext.SaveChangesAsync();
        ...
        public async Task WhenAddressWasCorrectedFromRetiredToCurrent()
        {
            ...
            await _streetNameConsumerContext.StreetNameLatestItems.AddAsync(
                new StreetNameLatestItem(
                    addressWasCorrectedFromRetiredToCurrent.StreetNamePersistentLocalId,
                    nisCode));
            await _streetNameConsumerContext.SaveChangesAsync();
        ...
        public async Task WhenAddressPostalCodeWasChangedV2()
        {
            ...
            await _streetNameConsumerContext.StreetNameLatestItems.AddAsync(
                new StreetNameLatestItem(
                    addressPostalCodeWasChangedV2.StreetNamePersistentLocalId,
                    nisCode));
            await _streetNameConsumerContext.SaveChangesAsync();
        ...
        public async Task WhenAddressPostalCodeWasCorrectedV2()
        {
            ...
            await _streetNameConsumerContext.StreetNameLatestItems.AddAsync(
                new StreetNameLatestItem(
                    addressPostalCodeWasCorrectedV2.StreetNamePersistentLocalId,
                    nisCode));
            await _streetNameConsumerContext.SaveChangesAsync();
        ...
        public async Task WhenAddressHouseNumberWasCorrectedV2()
        {
            ...
            await _streetNameConsumerContext.StreetNameLatestItems.AddAsync(
                new StreetNameLatestItem(
                    addressHouseNumberWasCorrectedV2.StreetNamePersistentLocalId,
                    nisCode));
            await _streetNameConsumerContext.SaveChangesAsync();
        ...
        public async Task WhenAddressBoxNumberWasCorrectedV2()
        {
            ...
            await _streetNameConsumerContext.StreetNameLatestItems.AddAsync(
                new StreetNameLatestItem(
                    addressBoxNumberWasCorrectedV2.StreetNamePersistentLocalId,
                    nisCode));
            await _streetNameConsumerContext.SaveChangesAsync();
        ...
        public async Task WhenAddressPositionWasChanged()
        {
            ...
            await _streetNameConsumerContext.StreetNameLatestItems.AddAsync(
                new StreetNameLatestItem(
                    addressPositionWasChanged.StreetNamePersistentLocalId,
                    nisCode));
            await _streetNameConsumerContext.SaveChangesAsync();
            ...
            await Sut
                ...
                .Then(async ct =>
                {
                    ...
                    expectedLatestItem.Removed.Should().BeFalse();
                    expectedLatestItem.NisCode.Should().Be(nisCode);
                    expectedLatestItem.PositionMethod.Should().Be(addressPositionWasChanged.GeometryMethod.ToPositieGeometrieMethode());
                    expectedLatestItem.PositionSpecification.Should()
        ...
        public async Task WhenAddressPositionWasCorrectedV2()
        {
            ...
            await _streetNameConsumerContext.StreetNameLatestItems.AddAsync(
                new StreetNameLatestItem(
                    addressPositionWasCorrectedV2.StreetNamePersistentLocalId,
                    nisCode));
            await _streetNameConsumerContext.SaveChangesAsync();
            ...
            await Sut
                ...
                .Then(async ct =>
                {
                    ...
                    expectedLatestItem.Removed.Should().BeFalse();
                    expectedLatestItem.NisCode.Should().Be(nisCode);
                    expectedLatestItem.PositionMethod.Should().Be(addressPositionWasCorrectedV2.GeometryMethod.ToPositieGeometrieMethode());
                    expectedLatestItem.PositionSpecification.Should()
        ...
        public async Task WhenAddressHouseNumberWasReaddressed()
        {
            ...
            await Sut
                ...
                .Then(async ct =>
                {
                    ...
                    houseNumberItem!.Status.Should().Be(readdressedHouseNumber.SourceStatus.Map());
                    ...
                    houseNumberItem.PositionMethod.Should().Be(readdressedHouseNumber.SourceGeometryMethod.ToPositieGeometrieMethode());
                    houseNumberItem.PositionSpecification.Should().Be(readdressedHouseNumber.SourceGeometrySpecification.ToPositieSpecificatie());
                    ...
                    houseNumberItem.IdempotenceKey.Should().Be(position + 2);
                    houseNumberItem.VersionTimestamp.Should().Be(addressHouseNumberWasReaddressed.Provenance.Timestamp);


                    var boxNumberItem = await ct.AddressLatestItems.FindAsync(addressBoxNumberWasProposedV2.AddressPersistentLocalId);
                    houseNumberItem.Should().NotBeNull();
                    boxNumberItem!.Status.Should().Be(readdressedBoxNumber.SourceStatus.Map());
                    ...
                    boxNumberItem.PositionMethod.Should().Be(readdressedBoxNumber.SourceGeometryMethod.ToPositieGeometrieMethode());
                    boxNumberItem.PositionSpecification.Should().Be(readdressedBoxNumber.SourceGeometrySpecification.ToPositieSpecificatie());
                    ...
                    boxNumberItem.IdempotenceKey.Should().Be(position + 2);
                    boxNumberItem.VersionTimestamp.Should().Be(addressHouseNumberWasReaddressed.Provenance.Timestamp);
                });
        }
        ...
        public async Task WhenAddressWasProposedBecauseOfReaddress()
        {
            ...
            await _streetNameConsumerContext.StreetNameLatestItems.AddAsync(
                new StreetNameLatestItem(
                    addressWasProposedBecauseOfReaddress.StreetNamePersistentLocalId,
                    nisCode));
            await _streetNameConsumerContext.SaveChangesAsync();
            ...
            await Sut
                ...
                .Then(async ct =>
                {
                    ...
                    expectedLatestItem.Status.Should().Be(AddressStatus.Proposed.Map());
                    expectedLatestItem.OfficiallyAssigned.Should().BeTrue();
                    expectedLatestItem.PositionMethod.Should().Be(addressWasProposedBecauseOfReaddress.GeometryMethod.ToPositieGeometrieMethode());
                    expectedLatestItem.PositionSpecification.Should()
        ...
        public async Task WhenAddressWasRejectedBecauseOfReaddress()
        {
            ...
            await _streetNameConsumerContext.StreetNameLatestItems.AddAsync(
                new StreetNameLatestItem(
                    addressWasRejectedBecauseOfReaddress.StreetNamePersistentLocalId,
                    nisCode));
            await _streetNameConsumerContext.SaveChangesAsync();
        ...
        public async Task WhenAddressWasRetiredBecauseOfReaddress()
        {
            ...
            await _streetNameConsumerContext.StreetNameLatestItems.AddAsync(
                new StreetNameLatestItem(
                    addressWasRetiredBecauseOfReaddress.StreetNamePersistentLocalId,
                    nisCode));
            await _streetNameConsumerContext.SaveChangesAsync();
        ...
        public async Task WhenAddressWasRemovedBecauseStreetNameWasRemoved()
        {
            ...
            await _streetNameConsumerContext.StreetNameLatestItems.AddAsync(
                new StreetNameLatestItem(
                    addressWasRemovedBecauseStreetNameWasRemoved.StreetNamePersistentLocalId,
                    nisCode));
            await _streetNameConsumerContext.SaveChangesAsync();
        ...
        public async Task WhenAddressWasRemovedBecauseHouseNumberWasRemoved()
        {
            ...
            await _streetNameConsumerContext.StreetNameLatestItems.AddAsync(
                new StreetNameLatestItem(
                    addressWasRemovedBecauseHouseNumberWasRemoved.StreetNamePersistentLocalId,
                    nisCode));
            await _streetNameConsumerContext.SaveChangesAsync();
        ...
        public async Task WhenAddressWasCorrectedFromRejectedToProposed()
        {
            ...
            await _streetNameConsumerContext.StreetNameLatestItems.AddAsync(
                new StreetNameLatestItem(
                    addressWasCorrectedFromRejectedToProposed.StreetNamePersistentLocalId,
                    nisCode));
            await _streetNameConsumerContext.SaveChangesAsync();
        ...
        public async Task WhenAddressRegularizationWasCorrected()
        {
            ...
            await _streetNameConsumerContext.StreetNameLatestItems.AddAsync(
                new StreetNameLatestItem(
                    addressRegularizationWasCorrected.StreetNamePersistentLocalId,
                    nisCode));
            await _streetNameConsumerContext.SaveChangesAsync();
...
[Fact]
        public async Task WhenAddressDeregulationWasCorrected()
        {
            ...
            await _streetNameConsumerContext.StreetNameLatestItems.AddAsync(
                new StreetNameLatestItem(
                    addressDeregulationWasCorrected.StreetNamePersistentLocalId,
                    nisCode));
            await _streetNameConsumerContext.SaveChangesAsync();
        ...
        protected override AddressLatestItemProjections CreateProjection()
            => new AddressLatestItemProjections(
                _streetNameConsumerContext,
                new OptionsWrapper<IntegrationOptions>(new IntegrationOptions { Namespace = Namespace }));

        private StreetNameConsumerContext CreateStreetNameConsumerContext()
        {
