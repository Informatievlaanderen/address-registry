namespace AddressRegistry.Consumer.Read.StreetName.Infrastructure
{
    ...
    public static class MigrationsHelper
    {
        ...
        {
            var migratorOptions = new DbContextOptionsBuilder<StreetNameConsumerContext>()
                .UseSqlServer(
                    connectionString,
                    sqlServerOptions =>
                    {
            ...
            await using var migrator = new StreetNameConsumerContext(migratorOptions.Options);
