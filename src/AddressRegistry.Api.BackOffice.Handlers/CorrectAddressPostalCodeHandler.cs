namespace AddressRegistry.Api.BackOffice.Handlers
{
    ...
    public sealed class CorrectAddressPostalCodeHandler : BusHandler, IRequestHandler<AddressCorrectPostalCodeRequest, ETagResponse>
    {
        ...
        public CorrectAddressPostalCodeHandler(
