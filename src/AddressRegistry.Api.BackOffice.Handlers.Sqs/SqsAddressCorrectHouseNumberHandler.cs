namespace AddressRegistry.Api.BackOffice.Handlers.Sqs
{
    ...
    public class SqsAddressCorrectHouseNumberHandler : SqsHandler<SqsAddressCorrectHouseNumberRequest>
    {
        private readonly BackOfficeContext _backOfficeContext;

        public SqsAddressCorrectHouseNumberHandler(
            ILogger<SqsAddressCorrectHouseNumberHandler> logger,
        ...
        protected override string WithGroupId(SqsAddressCorrectHouseNumberRequest request)
        {
