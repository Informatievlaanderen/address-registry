namespace AddressRegistry.Api.Oslo.AddressMatch.V2.Responses
{
    using System;
    ...
    public class AdresMatchOsloItem
    {
        ...
        public static AdresMatchOsloItem Create(AddressMatchScoreableItemV2 scoreableItem,
            ResponseOptionsV2 responseOptions)
        {
    ...
    {
        private readonly ResponseOptionsV2 _options;

        public AddressMatchResponseExamples(IOptions<ResponseOptionsV2> options)
        {
