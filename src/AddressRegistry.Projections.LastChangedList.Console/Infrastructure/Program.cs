namespace AddressRegistry.Projections.LastChangedList.Console.Infrastructure
{
    ...
    public class Program
    {
        ...
        public static async Task Main(string[] args)
        {
            ...
            Log.Information("Initializing AddressRegistry.Projections.LastChangedList.Console");
            ...
            Log.Information("Starting AddressRegistry.Projections.LastChangedList.Console");
