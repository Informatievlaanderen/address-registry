namespace AddressRegistry.Tests.BackOffice.Sqs
{
    ...
    public sealed class GivenAddressBackOfficeCorrectPositionRequest : AddressRegistryBackOfficeTest
    {
        private readonly TestBackOfficeContext _backOfficeContext;

        public GivenAddressBackOfficeCorrectPositionRequest(ITestOutputHelper testOutputHelper) : base(testOutputHelper)
        {
        ...
        public void WithNoStreetNameFoundByAddressPersistentLocalId_ThrowsAggregateIdNotFound()
        {
            ...
            var act = async () => await sut.Handle(
                new SqsAddressCorrectPositionRequest
                {
                    Request = Fixture.Create<AddressBackOfficeCorrectPositionRequest>()
                }, CancellationToken.None);
