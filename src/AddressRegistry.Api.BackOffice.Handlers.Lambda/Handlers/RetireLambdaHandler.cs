namespace AddressRegistry.Api.BackOffice.Handlers.Lambda.Handlers
{
    ...
    public sealed class RetireLambdaHandler : SqsLambdaHandler<RetireLambdaRequest>
    {
        public RetireLambdaHandler(
        ...
        protected override async Task<ETagResponse> InnerHandle(RetireLambdaRequest request, CancellationToken cancellationToken)
        {
        ...
        protected override TicketError? InnerMapDomainException(DomainException exception, RetireLambdaRequest request)
        {
