namespace AddressRegistry.Projections.Wfs.AddressWfsV3
{
    ...
    public sealed class HouseNumberLabelUpdater : IHouseNumberLabelUpdater
    {
        ...
        private async Task<IList<AddressWfsV3Item>> FindAddressesWithSharedPositionAndTheirBoxNumbers(
            WfsContext context,
            ...
            CancellationToken ct)
        {
            ...
            var localItems = context.AddressWfsV3Items.Local.ToList();

            var dbItems = await context.AddressWfsV3Items
                .Where(i => i.PositionX == position.X
                            && i.PositionY == position.Y
                            && i.AddressPersistentLocalId != addressPersistentLocalId
                            && i.Status == status
            ...
            var verifiedDbItems = new List<AddressWfsV3Item>();
        ...
        private static string? CalculateHouseNumberLabel(IEnumerable<AddressWfsV3Item> addresses)
        {
