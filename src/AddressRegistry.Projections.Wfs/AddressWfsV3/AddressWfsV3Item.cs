namespace AddressRegistry.Projections.Wfs.AddressWfsV3
{
    ...
    public class AddressWfsV3Item
    {
        protected AddressWfsV3Item()
        { }

        public AddressWfsV3Item(
    ...
    public class AddressWfsV3ItemConfiguration : IEntityTypeConfiguration<AddressWfsV3Item>
    {
        internal const string TableName = "AddressWfsV3";

        public void Configure(EntityTypeBuilder<AddressWfsV3Item> b)
        {
