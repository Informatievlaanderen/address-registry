namespace AddressRegistry.Projections.Api.AddressDetail
{
    ...
    public class AddressDetailProjections : ConnectedProjection<ApiContext>
    {
        public AddressDetailProjections()
        {
            ...
            {
                var addressDetailItem = new AddressDetailItem(
                ...
                UpdateHash(addressDetailItem, message);

                await context
                    .AddressDetails
                    .AddAsync(addressDetailItem, ct);
            });
        ...
        private static void UpdateHash<T>(AddressDetailItem entity, Envelope<T> wrappedEvent) where T : IHaveHash, IMessage
        {
        ...
        private static void UpdateVersionTimestampIfNewer(AddressDetailItem addressDetailItem, Instant versionTimestamp)
        {
        ...
        private static Task DoNothing<T>(ApiContext context, Envelope<T> envelope, CancellationToken ct) where T: IMessage => Task.CompletedTask;
    }
}
