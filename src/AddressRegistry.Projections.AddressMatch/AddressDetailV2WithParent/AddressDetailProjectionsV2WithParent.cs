namespace AddressRegistry.Projections.AddressMatch.AddressDetailV2WithParent
{
    using System;
    ...
    public class AddressDetailProjectionsV2WithParent : ConnectedProjection<AddressMatchContext>
    {
        ...
        private static Task DoNothing<T>(AddressMatchContext context, Envelope<T> envelope, CancellationToken ct) where T: IMessage => Task.CompletedTask;
    }
}
