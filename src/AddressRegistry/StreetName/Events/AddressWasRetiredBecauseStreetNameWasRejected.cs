namespace AddressRegistry.StreetName.Events
{
    ...
    [EventName(EventName)]
    [EventDescription("Het adres met status inGebruik werd gehistoreerd door afkeuring straatnaam.")]
    public class AddressWasRetiredBecauseStreetNameWasRejected : IStreetNameEvent, IHasAddressPersistentLocalId
    {
        public const string EventName = "AddressWasRetiredBecauseStreetNameWasRejected"; // BE CAREFUL CHANGING THIS!!
        ...
        [JsonConstructor]
        private AddressWasRetiredBecauseStreetNameWasRejected(
