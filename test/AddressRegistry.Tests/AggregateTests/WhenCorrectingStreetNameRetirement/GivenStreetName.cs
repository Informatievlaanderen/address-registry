namespace AddressRegistry.Tests.AggregateTests.WhenCorrectingStreetNameRetirement
{
    ...
    public class GivenStreetName : AddressRegistryTest
    {
        ...
        [Fact]
        public void ThenStreetNameWasCorrectedFromRetirementToProposed()
        {
            ...
            Assert(new Scenario()
                ...
                .Then(
                    new Fact(new StreetNameStreamId(command.PersistentLocalId),
                        new StreetNameWasCorrectedFromRetiredToCurrent(streetNamePersistentLocalId))));
        }

        [Fact]
        public void WithAlreadyCurrentStreetName_ThenNone()
        {
            var command = Fixture.Create<CorrectStreetNameRetirement>();
        ...
        public void StateCheck()
        {
            ...
            // Act
            sut.CorrectStreetNameRetirement();
