namespace AddressRegistry.Api.BackOffice
{
    ...
    public partial class AddressController
    {
        ...
        /// <returns></returns>
        [HttpPost("{persistentLocalId}/acties/corrigeren/busnummer")]
        ...
        public async Task<IActionResult> CorrectBoxNumber(
            ...
            [FromServices] IValidator<AddressCorrectBoxNumberRequest> validator,
            [FromServices] IIfMatchHeaderValidator ifMatchHeaderValidator,
            [FromServices] IOptions<ResponseOptions> options,
            [FromRoute] int persistentLocalId,
            [FromBody] AddressCorrectBoxNumberRequest request,
