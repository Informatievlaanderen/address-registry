namespace AddressRegistry.Tests.ProjectionTests.Municipality
{
    ...
    public class MunicipalityBosaItemProjectionsTests : KafkaProjectionTest<MunicipalityConsumerContext, MunicipalityBosaItemProjections>
    {
        ...
        {
            { MunicipalityBosaItemProjections.Dutch, "nl-name" },
            { MunicipalityBosaItemProjections.French, "fr-name" },
            { MunicipalityBosaItemProjections.German, "ger-name" },
            { MunicipalityBosaItemProjections.English, "en-name" },
        };
        ...
        public async Task MunicipalityWasRegistered()
        {
            ...
            {
                var result = await ctx.MunicipalityBosaItems.FindAsync(_municipalityGuid);
        ...
        public async Task MunicipalityWasNamed()
        {
            ...
            await Then(async ctx =>
            {
                ...
                result.NameDutchSearch.Should().Be("nlname");
                result.VersionTimestamp.Should().Be(InstantPattern.General.Parse(_provenance.Timestamp).Value);
            });
        }
        ...
        public async Task MunicipalityNameWasCorrected()
        {
            ...
            await Then(async ctx =>
            {
                ...
                result.Should().NotBeNull();
                result.NameDutch.Should().Be(e.Name);
                result.NameDutchSearch.Should().Be("dutchname");
                result.VersionTimestamp.Should().Be(InstantPattern.General.Parse(_provenance.Timestamp).Value);
            });
        }
        ...
        private static void AssertNames(MunicipalityBosaItem item)
        {
