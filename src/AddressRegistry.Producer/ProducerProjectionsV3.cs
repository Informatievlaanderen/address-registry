namespace AddressRegistry.Producer
{
    ...
    [ConnectedProjectionName("Kafka producer V3")]
    [ConnectedProjectionDescription("Projectie die berichten naar de kafka broker stuurt.")]
    public class ProducerProjectionsV3 : ConnectedProjection<ProducerContext>
    {
        public const string AddressTopicKey = "AddressV3Topic";

        private readonly IProducer _producer;

        public ProducerProjectionsV3(
            IProducer producer,
