namespace AddressRegistry.StreetName.Events
{
    ...
    public class AddressWasRetiredV2 : IStreetNameEvent, IHasAddressPersistentLocalId
    {
        public const string EventName = "AddressWasRetiredV2"; // BE CAREFUL CHANGING THIS!!
