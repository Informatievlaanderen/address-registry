namespace AddressRegistry.Tests.BackOffice.Lambda.WhenReaddress
{
    ...
    public class GivenSourceAddressPostalCodeMunicipalityDoesNotMatchStreetNameMunicipality : BackOfficeLambdaTest
    {
        private readonly BackOfficeContext _fakeBackOfficeContext;

        public GivenSourceAddressPostalCodeMunicipalityDoesNotMatchStreetNameMunicipality(ITestOutputHelper testOutputHelper) : base(testOutputHelper)
        {
        ...
        public async Task ThenTicketingErrorIsExpected()
        {
            ...
            var sut = new ReaddressLambdaHandler(
                ...
                MockExceptionIdempotentCommandHandler(() => new PostalCodeMunicipalityDoesNotMatchStreetNameMunicipalityException(new AddressPersistentLocalId(1))).Object,
