namespace AddressRegistry.Tests.ProjectionTests.WmsV3
{
    ...
    public partial class AddressWmsItemV3HouseNumberLabelTests : AddressWmsItemV3ProjectionTest
    {
        private readonly Fixture _fixture;
        private readonly WKBReader _wkbReader;

        public AddressWmsItemV3HouseNumberLabelTests()
        {
        ...
        private AddressWasProposedV2 CreateHouseNumberOneWasProposed()
        {
            return _fixture.Create<AddressWasProposedV2>()
                .WithHouseNumber(new HouseNumber("1"))
                .WithParentAddressPersistentLocalId(null)
                .WithBoxNumber(null);
        }
