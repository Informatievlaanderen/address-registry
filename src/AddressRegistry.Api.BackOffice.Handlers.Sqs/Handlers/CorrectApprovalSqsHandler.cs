namespace AddressRegistry.Api.BackOffice.Handlers.Sqs.Handlers
{
    ...
    public sealed class CorrectApprovalSqsHandler : SqsHandler<CorrectApprovalSqsRequest>
    {
        public const string Action = "CorrectAddressApproval";
        private readonly BackOfficeContext _backOfficeContext;

        public CorrectApprovalSqsHandler(
            ISqsQueue sqsQueue,
        ...
        protected override string? WithAggregateId(CorrectApprovalSqsRequest request)
        {
        ...
        protected override IDictionary<string, string> WithTicketMetadata(string aggregateId, CorrectApprovalSqsRequest sqsRequest)
        {
