namespace AddressRegistry.StreetName.Events
{
    ...
    [EventName(EventName)]
    [EventDescription("Het adres met status voorgesteld werd afgekeurd door afkeuring straatnaam.")]
    public class AddressWasRejectedBecauseStreetNameWasRejected : IStreetNameEvent, IHasAddressPersistentLocalId
    {
        public const string EventName = "AddressWasRejectedBecauseStreetNameWasRejected"; // BE CAREFUL CHANGING THIS!!
        ...
        [JsonConstructor]
        private AddressWasRejectedBecauseStreetNameWasRejected(
