namespace AddressRegistry.Api.BackOffice.Handlers.Lambda.Handlers
{
    ...
    public sealed class CorrectApprovalLambdaHandler : SqsLambdaHandler<CorrectApprovalLambdaRequest>
    {
        public CorrectApprovalLambdaHandler(
        ...
        protected override async Task<ETagResponse> InnerHandle(CorrectApprovalLambdaRequest request, CancellationToken cancellationToken)
        {
        ...
        protected override TicketError? InnerMapDomainException(DomainException exception, CorrectApprovalLambdaRequest request)
        {
