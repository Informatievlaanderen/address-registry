namespace AddressRegistry.Api.BackOffice.Handlers.Sqs.Handlers
{
    ...
    public sealed class ChangePositionSqsHandler : SqsHandler<ChangePositionSqsRequest>
    {
        public const string Action = "ChangeAddressPosition";

        private readonly BackOfficeContext _backOfficeContext;

        public ChangePositionSqsHandler(
            ISqsQueue sqsQueue,
        ...
        protected override string? WithAggregateId(ChangePositionSqsRequest request)
        {
        ...
        protected override IDictionary<string, string> WithTicketMetadata(string aggregateId, ChangePositionSqsRequest sqsRequest)
        {
