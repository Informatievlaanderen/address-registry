namespace AddressRegistry.Tests.BackOffice.Sqs
{
    ...
    public sealed class GivenAddressBackOfficeCorrectPostalCodeRequest : AddressRegistryTest
    {
        ...
        public GivenAddressBackOfficeCorrectPostalCodeRequest(ITestOutputHelper testOutputHelper) : base(testOutputHelper)
        {
        ...
        public async Task ThenTicketWithLocationIsCreated()
        {
            ...
            var sqsRequest = new SqsAddressCorrectPostalCodeRequest
            {
        ...
        public void WithNoStreetNameFoundByAddressPersistentLocalId_ThrowsAggregateIdNotFound()
        {
            ...
            var act = async () => await sut.Handle(
                new SqsAddressCorrectPostalCodeRequest
                {
                    Request = Fixture.Create<AddressBackOfficeCorrectPostalCodeRequest>()
                }, CancellationToken.None);
