namespace AddressRegistry.Api.BackOffice.Handlers.Sqs.Handlers
{
    ...
    public sealed class RemoveSqsHandler : SqsHandler<RemoveSqsRequest>
    {
        public const string Action = "RemoveAddress";

        private readonly BackOfficeContext _backOfficeContext;

        public RemoveSqsHandler(
            ISqsQueue sqsQueue,
        ...
        protected override string? WithAggregateId(RemoveSqsRequest request)
        {
        ...
        protected override IDictionary<string, string> WithTicketMetadata(string aggregateId, RemoveSqsRequest sqsRequest)
        {
