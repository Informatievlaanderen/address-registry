namespace AddressRegistry.Api.BackOffice.Handlers.Sqs.Handlers
{
    ...
    public sealed class SqsAddressChangePostalCodeHandler : SqsHandler<SqsAddressChangePostalCodeRequest>
    {
        ...
        protected override string? WithAggregateId(SqsAddressChangePostalCodeRequest request)
        {
        ...
        protected override IDictionary<string, string> WithTicketMetadata(string aggregateId, SqsAddressChangePostalCodeRequest sqsRequest)
        {
