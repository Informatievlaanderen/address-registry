namespace AddressRegistry.Api.Oslo.AddressMatch.Responses
{
    ...
    public class AdresMatchOsloItem
    {
        ...
        public List<AdresseerbaarOsloObject> AdresseerbareObjecten { get; set; }
            ...
            ResponseOptions responseOptions)
        {
            return new AdresMatchOsloItem
            {
                ...
                AdresseerbareObjecten = buildingContext
                    ...
                    .ToList()
                    .Select(matchLatestItem => new AdresseerbaarOsloObject
                    {
    ...
    public class AdresseerbaarOsloObject
    {
        /// <summary>
    ...
    public class AddressMatchOsloResponseExamples : IExamplesProvider<AddressMatchOsloCollection>
    {
        private readonly ResponseOptions _options;

        public AddressMatchOsloResponseExamples(IOptions<ResponseOptions> options)
        {
            ...
            return new AddressMatchOsloCollection
            {
                AdresMatches = new List<AdresMatchOsloItem>
                {
                    new AdresMatchOsloItem
                    {
                        ...
                        AdresseerbareObjecten = new List<AdresseerbaarOsloObject>
                        {
                            new AdresseerbaarOsloObject
                            {
                                ObjectId = "3466",
                                ObjectType = ObjectType.Gebouweenheid,
