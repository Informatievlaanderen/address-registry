namespace AddressRegistry.Api.BackOffice.IntegrationTests
{
    ...
    public class IntegrationTests : IClassFixture<IntegrationTestFixture>
    {
        ...
        [InlineData("/v2/adressen/1/acties/voorstellen/gemeentefusie/10000", "dv_ar_adres_beheer dv_ar_adres_uitzonderingen")]
        ...
        [InlineData("/v2/adressen/1/acties/voorstellen/gemeentefusie/10000")]
        ...
        [InlineData("/v2/adressen/1/acties/voorstellen/gemeentefusie/10000", "dv_ar_adres_beheer")]
        [InlineData("/v2/adressen/1/acties/voorstellen/gemeentefusie/10000", "dv_ar_adres_uitzonderingen")]
        [InlineData("/v2/adressen/1/acties/wijzigen/adrespositie")]
        [InlineData("/v2/adressen/1/acties/wijzigen/postcode")]
