namespace AddressRegistry.Api.BackOffice.Handlers.Sqs.Lambda.Handlers
{
    ...
    public class SqsAddressRemoveHandler : SqsLambdaHandler<SqsAddressRemoveRequest>
    {
        ...
        protected override async Task<string> Handle2(SqsAddressRemoveRequest request, CancellationToken cancellationToken)
        {
