namespace AddressRegistry.Api.BackOffice.Abstractions.Requests
{
    ...
    public class CorrectAddressPositionRequestExamples : IExamplesProvider<CorrectAddressPositionRequest>
    {
        public CorrectAddressPositionRequest GetExamples()
        {
            return new CorrectAddressPositionRequest
            {
