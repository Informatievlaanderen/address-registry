namespace AddressRegistry.Tests.Integration
{
    ...
    public sealed class AddressLatestItemV2Tests : IntegrationProjectionTest<AddressLatestItemProjectionsV2>
    {
        private const string Namespace = "https://data.vlaanderen.be/id/adres";
        private readonly Fixture _fixture;

        public AddressLatestItemV2Tests()
        {
            ...
            await Sut
                ...
                .Then(async ct =>
                {
                    var expectedLatestItem =
                        await ct.AddressLatestItemsV2.FindAsync(addressWasMigratedToStreetName.AddressPersistentLocalId);
        ...
        public async Task WhenAddressWasProposedV2()
        {
            ...
            await Sut
                ...
                {
                    var expectedLatestItem =
                        await ct.AddressLatestItemsV2.FindAsync(addressWasProposedV2.AddressPersistentLocalId);
                    expectedLatestItem.Should().NotBeNull();
        ...
        public async Task WhenAddressWasProposedForMunicipalityMerger()
        {
            ...
            await Sut
                ...
                {
                    var expectedLatestItem =
                        await ct.AddressLatestItemsV2.FindAsync(addressWasProposedForMunicipalityMerger.AddressPersistentLocalId);
                    expectedLatestItem.Should().NotBeNull();
        ...
        public async Task WhenAddressWasApproved()
        {
            ...
            await Sut
                ...
                {
                    var expectedLatestItem =
                        await ct.AddressLatestItemsV2.FindAsync(addressWasApproved.AddressPersistentLocalId);
                    expectedLatestItem.Should().NotBeNull();
        ...
        public async Task WhenAddressWasCorrectedFromApprovedToProposed()
        {
            ...
            await Sut
                ...
                {
                    var expectedLatestItem =
                        await ct.AddressLatestItemsV2.FindAsync(addressWasCorrectedFromApprovedToProposed.AddressPersistentLocalId);
                    expectedLatestItem.Should().NotBeNull();
        ...
        public async Task WhenAddressWasCorrectedFromApprovedToProposedBecauseHouseNumberWasCorrected()
        {
            ...
            await Sut
                ...
                {
                    var expectedLatestItem =
                        await ct.AddressLatestItemsV2.FindAsync(addressWasCorrectedFromApprovedToProposedBecauseHouseNumberWasCorrected
        ...
        public async Task WhenAddressWasRejected()
        {
            ...
            await Sut
                ...
                {
                    var expectedLatestItem =
                        await ct.AddressLatestItemsV2.FindAsync(addressWasRejected.AddressPersistentLocalId);
                    expectedLatestItem.Should().NotBeNull();
        ...
        public async Task WhenAddressWasRejectedBecauseHouseNumberWasRejected()
        {
            ...
            await Sut
                ...
                {
                    var expectedLatestItem =
                        await ct.AddressLatestItemsV2.FindAsync(addressWasRejectedBecauseHouseNumberWasRejected.AddressPersistentLocalId);
                    expectedLatestItem.Should().NotBeNull();
                    expectedLatestItem!.StreetNamePersistentLocalId.Should()
        ...
        public async Task WhenAddressWasRejectedBecauseHouseNumberWasRetired()
        {
            ...
            await Sut
                ...
                {
                    var expectedLatestItem =
                        await ct.AddressLatestItemsV2.FindAsync(addressWasRejectedBecauseHouseNumberWasRetired.AddressPersistentLocalId);
                    expectedLatestItem.Should().NotBeNull();
                    expectedLatestItem!.StreetNamePersistentLocalId.Should()
        ...
        public async Task WhenAddressWasRejectedBecauseStreetNameWasRejected()
        {
            ...
            await Sut
                ...
                {
                    var expectedLatestItem =
                        await ct.AddressLatestItemsV2.FindAsync(addressWasRejectedBecauseStreetNameWasRejected.AddressPersistentLocalId);
                    expectedLatestItem.Should().NotBeNull();
                    expectedLatestItem!.StreetNamePersistentLocalId.Should()
        ...
        public async Task WhenAddressWasRetiredBecauseStreetNameWasRejected()
        {
            ...
            await Sut
                ...
                {
                    var expectedLatestItem =
                        await ct.AddressLatestItemsV2.FindAsync(addressWasRetiredBecauseStreetNameWasRejected.AddressPersistentLocalId);
                    expectedLatestItem.Should().NotBeNull();
                    expectedLatestItem!.StreetNamePersistentLocalId.Should()
        ...
        public async Task WhenAddressWasRejectedBecauseStreetNameWasRetired()
        {
            ...
            await Sut
                ...
                {
                    var expectedLatestItem =
                        await ct.AddressLatestItemsV2.FindAsync(addressWasRejectedBecauseStreetNameWasRetired.AddressPersistentLocalId);
                    expectedLatestItem.Should().NotBeNull();
                    expectedLatestItem!.StreetNamePersistentLocalId.Should()
        ...
        public async Task WhenAddressWasDeregulated()
        {
            ...
            await Sut
                ...
                {
                    var expectedLatestItem =
                        await ct.AddressLatestItemsV2.FindAsync(addressWasDeregulated.AddressPersistentLocalId);
                    expectedLatestItem.Should().NotBeNull();
                    expectedLatestItem!.StreetNamePersistentLocalId.Should()
        ...
        public async Task WhenAddressWasRegularized()
        {
            ...
            await Sut
                ...
                {
                    var expectedLatestItem =
                        await ct.AddressLatestItemsV2.FindAsync(addressWasRegularized.AddressPersistentLocalId);
                    expectedLatestItem.Should().NotBeNull();
                    expectedLatestItem!.StreetNamePersistentLocalId.Should()
        ...
        public async Task WhenAddressWasRetiredV2()
        {
            ...
            await Sut
                ...
                {
                    var expectedLatestItem =
                        await ct.AddressLatestItemsV2.FindAsync(addressWasRetiredV2.AddressPersistentLocalId);
                    expectedLatestItem.Should().NotBeNull();
                    expectedLatestItem!.StreetNamePersistentLocalId.Should()
        ...
        public async Task WhenAddressWasRetiredBecauseOfMunicipalityMerger()
        {
            ...
            await Sut
                ...
                {
                    var expectedLatestItem =
                        await ct.AddressLatestItemsV2.FindAsync(addressWasRetired.AddressPersistentLocalId);
                    expectedLatestItem.Should().NotBeNull();
                    expectedLatestItem!.StreetNamePersistentLocalId.Should()
        ...
        public async Task WhenAddressWasRetiredBecauseHouseNumberWasRetired()
        {
            ...
            await Sut
                ...
                {
                    var expectedLatestItem =
                        await ct.AddressLatestItemsV2.FindAsync(addressWasRetiredBecauseHouseNumberWasRetired.AddressPersistentLocalId);
                    expectedLatestItem.Should().NotBeNull();
                    expectedLatestItem!.StreetNamePersistentLocalId.Should()
        ...
        public async Task WhenAddressWasRetiredBecauseStreetNameWasRetired()
        {
            ...
            await Sut
                ...
                {
                    var expectedLatestItem =
                        await ct.AddressLatestItemsV2.FindAsync(addressWasRetiredBecauseStreetNameWasRetired.AddressPersistentLocalId);
                    expectedLatestItem.Should().NotBeNull();
                    expectedLatestItem!.StreetNamePersistentLocalId.Should()
        ...
        public async Task WhenAddressWasCorrectedFromRetiredToCurrent()
        {
            ...
            await Sut
                ...
                {
                    var expectedLatestItem =
                        await ct.AddressLatestItemsV2.FindAsync(addressWasCorrectedFromRetiredToCurrent.AddressPersistentLocalId);
                    expectedLatestItem.Should().NotBeNull();
                    expectedLatestItem!.StreetNamePersistentLocalId.Should()
        ...
        public async Task WhenAddressPostalCodeWasChangedV2()
        {
            ...
            await Sut
                ...
                {
                    var expectedLatestItem =
                        await ct.AddressLatestItemsV2.FindAsync(addressPostalCodeWasChangedV2.AddressPersistentLocalId);
                    expectedLatestItem.Should().NotBeNull();
                    expectedLatestItem!.StreetNamePersistentLocalId.Should()
        ...
        public async Task WhenAddressPostalCodeWasCorrectedV2()
        {
            ...
            await Sut
                ...
                {
                    var expectedLatestItem =
                        await ct.AddressLatestItemsV2.FindAsync(addressPostalCodeWasCorrectedV2.AddressPersistentLocalId);
                    expectedLatestItem.Should().NotBeNull();
                    expectedLatestItem!.StreetNamePersistentLocalId.Should()
        ...
        public async Task WhenAddressHouseNumberWasCorrectedV2()
        {
            ...
            await Sut
                ...
                {
                    var expectedLatestItem =
                        await ct.AddressLatestItemsV2.FindAsync(addressHouseNumberWasCorrectedV2.AddressPersistentLocalId);
                    expectedLatestItem.Should().NotBeNull();
                    expectedLatestItem!.StreetNamePersistentLocalId.Should()
        ...
        public async Task WhenAddressBoxNumberWasCorrectedV2()
        {
            ...
            await Sut
                ...
                {
                    var expectedLatestItem =
                        await ct.AddressLatestItemsV2.FindAsync(addressBoxNumberWasCorrectedV2.AddressPersistentLocalId);
                    expectedLatestItem.Should().NotBeNull();
                    expectedLatestItem!.StreetNamePersistentLocalId.Should()
        ...
        public async Task WhenAddressBoxNumbersWereCorrected()
        {
            ...
            var addressBoxNumbersWereCorrected = new AddressBoxNumbersWereCorrected(
                ...
                {
                    {_fixture.Create<AddressPersistentLocalId>(), new BoxNumber("1B")}
                });
            ...
            await Sut
                ...
                .Then(async ct =>
                {
                    ...
                    var expectedLatestItem = await ct.AddressLatestItemsV2.FindAsync(addressPersistentLocalId);
                    expectedLatestItem.Should().NotBeNull();
                    expectedLatestItem!.BoxNumber.Should().Be(boxNumber);
                    expectedLatestItem.VersionTimestamp.Should().Be(addressBoxNumbersWereCorrected.Provenance.Timestamp);
                });
        }
        ...
        public async Task WhenAddressPositionWasChanged()
        {
            ...
            await Sut
                ...
                {
                    var expectedLatestItem =
                        await ct.AddressLatestItemsV2.FindAsync(addressPositionWasChanged.AddressPersistentLocalId);
                    expectedLatestItem.Should().NotBeNull();
                    expectedLatestItem!.StreetNamePersistentLocalId.Should()
        ...
        public async Task WhenAddressPositionWasCorrectedV2()
        {
            ...
            await Sut
                ...
                {
                    var expectedLatestItem =
                        await ct.AddressLatestItemsV2.FindAsync(addressPositionWasCorrectedV2.AddressPersistentLocalId);
                    expectedLatestItem.Should().NotBeNull();
                    expectedLatestItem!.StreetNamePersistentLocalId.Should()
        ...
        public async Task WhenAddressHouseNumberWasReaddressed()
        {
            ...
            await Sut
                ...
                .Then(async ct =>
                {
                    var houseNumberItem = await ct.AddressLatestItemsV2.FindAsync(addressWasProposedV2.AddressPersistentLocalId);
                    ...
                    var boxNumberItem = await ct.AddressLatestItemsV2.FindAsync(addressBoxNumberWasProposedV2.AddressPersistentLocalId);
        ...
        public async Task WhenAddressWasProposedBecauseOfReaddress()
        {
            ...
            await Sut
                ...
                {
                    var expectedLatestItem =
                        await ct.AddressLatestItemsV2.FindAsync(addressWasProposedBecauseOfReaddress.AddressPersistentLocalId);
                    expectedLatestItem.Should().NotBeNull();
        ...
        public async Task WhenAddressWasRejectedBecauseOfReaddress()
        {
            ...
            await Sut
                ...
                {
                    var expectedLatestItem =
                        await ct.AddressLatestItemsV2.FindAsync(addressWasRejectedBecauseOfReaddress.AddressPersistentLocalId);
                    expectedLatestItem.Should().NotBeNull();
        ...
        public async Task WhenAddressWasRetiredBecauseOfReaddress()
        {
            ...
            await Sut
                ...
                {
                    var expectedLatestItem =
                        await ct.AddressLatestItemsV2.FindAsync(addressWasRetiredBecauseOfReaddress.AddressPersistentLocalId);
                    expectedLatestItem.Should().NotBeNull();
        ...
        public async Task WhenAddressWasRemovedV2()
        {
            ...
            await Sut
                ...
                {
                    var expectedLatestItem =
                        await ct.AddressLatestItemsV2.FindAsync(addressWasRemovedV2.AddressPersistentLocalId);
                    expectedLatestItem.Should().NotBeNull();
        ...
        public async Task WhenAddressWasRemovedBecauseStreetNameWasRemoved()
        {
            ...
            await Sut
                ...
                {
                    var expectedLatestItem =
                        await ct.AddressLatestItemsV2.FindAsync(addressWasRemovedBecauseStreetNameWasRemoved.AddressPersistentLocalId);
                    expectedLatestItem.Should().NotBeNull();
                    expectedLatestItem!.StreetNamePersistentLocalId.Should()
        ...
        public async Task WhenAddressWasRemovedBecauseHouseNumberWasRemoved()
        {
            ...
            await Sut
                ...
                {
                    var expectedLatestItem =
                        await ct.AddressLatestItemsV2.FindAsync(addressWasRemovedBecauseHouseNumberWasRemoved.AddressPersistentLocalId);
                    expectedLatestItem.Should().NotBeNull();
                    expectedLatestItem!.StreetNamePersistentLocalId.Should()
        ...
        public async Task WhenAddressWasCorrectedFromRejectedToProposed()
        {
            ...
            await Sut
                ...
                {
                    var expectedLatestItem =
                        await ct.AddressLatestItemsV2.FindAsync(addressWasCorrectedFromRejectedToProposed.AddressPersistentLocalId);
                    expectedLatestItem.Should().NotBeNull();
                    expectedLatestItem!.StreetNamePersistentLocalId.Should()
        ...
        public async Task WhenAddressRegularizationWasCorrected()
        {
            ...
            await Sut
                ...
                {
                    var expectedLatestItem =
                        await ct.AddressLatestItemsV2.FindAsync(addressRegularizationWasCorrected.AddressPersistentLocalId);
                    expectedLatestItem.Should().NotBeNull();
                    expectedLatestItem!.StreetNamePersistentLocalId.Should()
        ...
        public async Task WhenAddressDeregulationWasCorrected()
        {
            ...
            await Sut
                ...
                {
                    var expectedLatestItem =
                        await ct.AddressLatestItemsV2.FindAsync(addressDeregulationWasCorrected.AddressPersistentLocalId);
                    expectedLatestItem.Should().NotBeNull();
                    expectedLatestItem!.StreetNamePersistentLocalId.Should()
        ...
        public async Task WhenAddressRemovalWasCorrected()
        {
            ...
            await Sut
                ...
                .Then(async ct =>
                {
                    ...
                    var expectedLatestItem =
                        await ct.AddressLatestItemsV2.FindAsync(@event.AddressPersistentLocalId);
                    expectedLatestItem.Should().NotBeNull();
