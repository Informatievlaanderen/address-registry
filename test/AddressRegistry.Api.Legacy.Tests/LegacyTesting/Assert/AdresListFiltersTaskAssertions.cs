namespace AddressRegistry.Api.Legacy.Tests.LegacyTesting.Assert
{
    ...
    public class AdresListFiltersTaskAssertions : TaskContinuationAssertion<AdresListFilterStub, AdresListFiltersTaskAssertions>
    {
        public AdresListFiltersTaskAssertions(Task<AdresListFilterStub> subject) : base(subject)
        {
        }
