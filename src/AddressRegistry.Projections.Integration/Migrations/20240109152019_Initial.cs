        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    nis_code = table.Column<string>(type: "character(5)", fixedLength: true, maxLength: 5, nullable: true),
                    ...
                    position_method = table.Column<string>(type: "text", nullable: true),
                    position_specification = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_address_latest_items_nis_code",
                schema: "integration_address",
                table: "address_latest_items",
                column: "nis_code");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_address_versions_nis_code",
                schema: "integration_address",
                table: "address_versions",
                column: "nis_code");
