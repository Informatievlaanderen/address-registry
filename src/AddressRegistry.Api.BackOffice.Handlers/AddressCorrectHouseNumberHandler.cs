namespace AddressRegistry.Api.BackOffice.Handlers
{
    ...
    public sealed class AddressCorrectHouseNumberHandler : BusHandler, IRequestHandler<AddressCorrectHouseNumberRequest, ETagResponse>
    {
        private readonly IStreetNames _streetNames;
        private readonly BackOfficeContext _backOfficeContext;
        private readonly IdempotencyContext _idempotencyContext;

        public AddressCorrectHouseNumberHandler(
        ...
        public async Task<ETagResponse> Handle(AddressCorrectHouseNumberRequest request, CancellationToken cancellationToken)
        {
