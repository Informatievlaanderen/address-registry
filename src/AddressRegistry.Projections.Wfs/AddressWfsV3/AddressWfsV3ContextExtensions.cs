namespace AddressRegistry.Projections.Wfs.AddressWfsV3
{
    ...
    public static class AddressWfsV3Extensions
    {
        public static async Task<AddressWfsV3Item> FindAndUpdateAddressDetail(
            this WfsContext context,
            int addressPersistentLocalId,
            Action<AddressWfsV3Item> updateAddressAction,
        ...
        public static async Task<AddressWfsV3Item> FindAddressDetail(
            this WfsContext context,
            int addressPersistentLocalId,
            ...
            bool allowRemovedAddress = false)
        {
            ...
            var address = await context.AddressWfsV3Items.FindAsync(addressPersistentLocalId, cancellationToken: ct);
        ...
        private static ProjectionItemNotFoundException<AddressWfsV3Projections> DatabaseItemNotFound(int addressPersistentLocalId)
            => new ProjectionItemNotFoundException<AddressWfsV3Projections>(addressPersistentLocalId.ToString());
    }
}
