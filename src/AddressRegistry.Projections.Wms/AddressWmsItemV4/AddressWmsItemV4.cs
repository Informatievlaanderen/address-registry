namespace AddressRegistry.Projections.Wms.AddressWmsItemV4
{
    ...
    public class AddressWmsItemV4
    {
        protected AddressWmsItemV4()
        { }

        public AddressWmsItemV4(
    ...
    public class AddressWmsItemV4Configuration : IEntityTypeConfiguration<AddressWmsItemV4>
    {
        internal const string TableName = "AddressWmsV4";

        public void Configure(EntityTypeBuilder<AddressWmsItemV4> b)
        {
