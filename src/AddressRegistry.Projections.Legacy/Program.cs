namespace AddressRegistry.Projections.Legacy
{
    ...
    public class Program
    {
        ...
        public static async Task Main(string[] args)
        {
            ...
            Console.WriteLine("Starting AddressRegistry.Projections.Legacy");
        ...
        {
            var runner = container.GetService<AddressLegacyRunner>();
            yield return runner.StartAsync(
                container.GetService<IStreamStore>(),
                container.GetService<Func<Owned<LegacyContext>>>(),
                ct);

            var municipalityRunner = new FeedProjectionRunner<MunicipalityEvent, Municipality, LegacyContext>(
                "municipality",
            ...
            var streetNameRunner = new FeedProjectionRunner<StreetNameEvent, StreetName, LegacyContext>(
                "streetname",
        ...
        private static IServiceProvider ConfigureServices(IConfiguration configuration)
        {
            ...
            builder
                .RegisterType<AddressLegacyRunner>()
                .SingleInstance();
