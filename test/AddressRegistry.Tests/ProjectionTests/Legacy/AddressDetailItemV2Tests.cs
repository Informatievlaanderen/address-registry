    ...
    public class AddressDetailItemV2Tests : AddressLegacyProjectionTest<AddressDetailProjectionsV2>
    {
        ...
        public async Task WhenAddressWasProposedBecauseOfMunicipalityMerger()
        {
            ...
            await Sut
                ...
                .Then(async ct =>
                {
                    var addressDetailItemV2 = (await ct.AddressDetailV2.FindAsync(addressWasProposedBecauseOfMunicipalityMerger.AddressPersistentLocalId));
                    addressDetailItemV2.Should().NotBeNull();
        ...
        public async Task WhenAddressWasProposedBecauseOfReaddress()
        {
            ...
            await Sut
                ...
                .Then(async ct =>
                {
                    var addressDetailItemV2 = (await ct.AddressDetailV2.FindAsync(addressWasProposed.AddressPersistentLocalId));
                    addressDetailItemV2.Should().NotBeNull();
