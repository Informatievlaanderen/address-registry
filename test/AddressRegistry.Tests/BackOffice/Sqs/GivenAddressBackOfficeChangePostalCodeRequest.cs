namespace AddressRegistry.Tests.BackOffice.Sqs
{
    ...
    public sealed class GivenAddressBackOfficeChangePostalCodeRequest : AddressRegistryTest
    {
        private readonly TestBackOfficeContext _backOfficeContext;

        public GivenAddressBackOfficeChangePostalCodeRequest(ITestOutputHelper testOutputHelper) : base(testOutputHelper)
        {
        ...
        public async Task ThenTicketWithLocationIsCreated()
        {
            ...
            var sut = new ChangePostalCodeSqsHandler(
                sqsQueue.Object,
            ...
            var sqsRequest = new ChangePostalCodeSqsRequest
            {
                ...
                Request = new BackOfficeChangePostalCodeRequest()
            };
        ...
        public void WithNoStreetNameFoundByAddressPersistentLocalId_ThrowsAggregateIdNotFound()
        {
            ...
            var act = async () => await sut.Handle(
                new ChangePostalCodeSqsRequest
                {
                    Request = Fixture.Create<BackOfficeChangePostalCodeRequest>()
                }, CancellationToken.None);
