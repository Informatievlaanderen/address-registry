namespace AddressRegistry.Api.Legacy.Tests.LegacyTesting.Assert
{
    ...
    public class HuisnummerWithSubadresTaskAssertions : TaskContinuationAssertion<HouseNumberWithSubaddress, HuisnummerWithSubadresTaskAssertions>
    {
        public HuisnummerWithSubadresTaskAssertions(Task<HouseNumberWithSubaddress> subject) : base(subject)
        {
        }
