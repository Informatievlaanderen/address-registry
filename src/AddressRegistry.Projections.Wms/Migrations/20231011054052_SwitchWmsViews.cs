...
namespace AddressRegistry.Projections.Wms.Migrations
{
    public partial class SwitchWmsViews : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("DROP VIEW [wms].[AdresAfgekeurdV2]");
            migrationBuilder.Sql("DROP VIEW [wms].[AdresVoorgesteld]");
            migrationBuilder.Sql("DROP VIEW [wms].[AdresVoorgesteldV2]");
            migrationBuilder.Sql("DROP VIEW [wms].[AdresInGebruik]");
            migrationBuilder.Sql("DROP VIEW [wms].[AdresInGebruikV2]");
            migrationBuilder.Sql("DROP VIEW [wms].[AdresGehistoreerd]");
            migrationBuilder.Sql("DROP VIEW [wms].[AdresGehistoreerdV2]");
...
WHERE a.[PersistentLocalId] is not null
                ");
