namespace AddressRegistry.Api.BackOffice.Handlers
{
    ...
    public sealed class DeregulateAddressHandler : BusHandler, IRequestHandler<AddressDeregulateRequest, ETagResponse>
    {
        private readonly IStreetNames _streetNames;
        private readonly BackOfficeContext _backOfficeContext;
        private readonly IdempotencyContext _idempotencyContext;

        public DeregulateAddressHandler(
        ...
        public async Task<ETagResponse> Handle(AddressDeregulateRequest request, CancellationToken cancellationToken)
        {
